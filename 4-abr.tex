...
\begin{itemize}[noitemsep,topsep=0pt]
  ...
  \item \texttt{\textbf{HLSjs}}. This is an implementation of \texttt{AbrAlgorithm} based on \textit{hls.js}\cite{hls3}.
  \item \texttt{\textbf{DASHjs}}. This is an implementation of \texttt{AbrAlgorithm} based on \textit{dash.js}\cite{dash3}. 
  It also contains the implementation of the buffer based algorithm BOLA.
