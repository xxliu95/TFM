...
\lstdefinelanguage{myC++}{
    ...
    MyClass, Socket, TcpSocketFactory, PointToPointHelper},
    ...
    SetSendCallback, SetRecvCallback, GetTypeId, ConnectionSucceeded, ConnectionFailed,
    SetDeviceAttribute, SetChannelAttribute},
    morekeywords=[3]{Ptr, this},
    comment=[l]{//}
}
