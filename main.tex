...
\newcommand{\tfmtitle}{FULL TITLE OF THE THESIS}
\newcommand{\tfmtitlees}{TITULO COMPLETO DEL TFM}
\newcommand{\supervisor}{NOMBRE DEL TUTOR}
...
\phantomsection
\nocite{*}
\addcontentsline{toc}{chapter}{Referencias}   % ieeetr
\bibliographystyle{unsrt}
