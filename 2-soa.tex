...
\subsubsection{Wireless Fundamentals}
...
\begin{itemize}
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[width=0.76\textwidth]{img/pathloss.png}
    \caption{Shadowing effect. Source:\cite{lte2} }
    \label{fig:pathloss}
  \end{figure}

  \item \textbf{Fading loss} 
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[width=0.76\textwidth]{img/fading.png}
